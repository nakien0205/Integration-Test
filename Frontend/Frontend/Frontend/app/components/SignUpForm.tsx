...
export default function SignUpForm({ onToggle, onSubmit, onGoogleAuth }: SignUpFormProps) {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-2 text-black dark:text-white">Create an account</h2>
      <p className="text-gray-600 dark:text-gray-400 mb-8">Join and Shop Anything..</p>
